  ...
  return (
    <nav className="fixed mx-auto border border-[#33353F] top-0 left-0 right-0 z-10 bg-[#121212]">
        <div className="flex flex-wrap items-center justify-between mx-auto py-4 px-10">
            <Link href={"/"} className="text-2xl md:text-3xl text-white font-semibold">Aishwarya<span className="text-purple-500 font-extrabold ml-1">.</span></Link>
            ...
            <Link className="mobile-menu block md:hidden" href="https://www.linkedin.com/in/aishwaryaparab" target="_blank">
